...
import { softwareDevelopmentPhases } from "@/data";
    ...
    return (
        <section className="w-full py-20">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4 mx-auto px-8">
                ...
                {
                    softwareDevelopmentPhases.map((phase, index) => (
                        <Card
                            title={phase.name}
                            icon={<AceternityIcon order={'Phase ' + (index + 1)} />} key={index}
    ...
    return (
        ...
        >
            ...
            <div className="relative z-20">
                ...
                <h2 className="dark:text-white text-lg opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-light group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200 items-center text-justify">
                    {description}
                </h2>
